...
const Companies = () => {
  const companies = [
    "HTML", "CSS", "JAVASCRIPT", "TYPESCRIPT", "PYTHON", "PHP", "REACT", "NEXT", "SVELTE", "SVELTEKIT",
    "MONGODB", "MYSQL", "NODEJS", "EXPRESS", "TAILWIND", "BOOTSTRAP", "FRAMER MOTION", "FIREBASE", "GITHUB", "VITE"
  ];
